...
- **Visualization get/update/delete/list** (only create is supported via CLI; full CRUD coming soon)
...
- **Always** confirm with the user before running write commands (`query create`, `query update`, `query archive`, `viz create`)
...
| Create visualizations (charts, tables, counters) on saved queries | [visualization-management.md](references/visualization-management.md) |
